    ...
    <main className="h-screen w-full flex bg-gray-900">
      ...
      <section className="relative h-full w-80 bg-gray-800 flex flex-col">
        ...
        <div className="flex flex-col flex-1 min-h-0 p-2">
          <div className="messages flex-1 flex flex-col gap-2 overflow-y-auto bg-gray-700 p-2 rounded-md">
            <div className="incoming-message max-w-[75%] bg-gray-600 p-3 rounded-lg text-white">
              <h3 className="text-sm">Hello, how are you?</h3>
              <small className="text-blue-400">user1@example.com</small>
            </div>

            <div className="outgoing-message max-w-[75%] bg-blue-600 p-3 ml-auto rounded-lg text-white self-end">
              <h3 className="text-sm">I'm good, thanks!</h3>
              <small className="text-gray-200">me@example.com</small>
            </div>
          </div>
          <div className="input-field flex mt-4 bg-gray-700 p-2 rounded-md">
            ...
            />
            <button className="ml-2 text-blue-600 hover:text-blue-700 flex-shrink-0 cursor-pointer">
              <IoIosSend size={24} />
            </button>
          </div>
        </div>
      ...
      {/* Right Section */}
      <section className="flex-1 h-full bg-black">
